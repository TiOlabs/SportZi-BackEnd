...
const ArcadeCanceledPackageEnrollmentPlayer = (
  email,
  package_name,
  arcade_name
) => {
...
<body>
    <div class="container">
        ...
        <p>We regret to inform you that ${arcade_name} has canceled your ${package_name} Package Enrollment .</p>
...
module.exports = { ArcadeCanceledPackageEnrollmentPlayer };
