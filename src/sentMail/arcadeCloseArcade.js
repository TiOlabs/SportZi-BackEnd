...
const ArcadeCloseArcade = (
  ...
  const mailoptions = {
    ...
    subject: "Booking Cancelation Notice",
    html: `<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <p>Dear ${user_name} ,</p>
        <p>We regret to inform you that ${arcade_name} has canceled your booking scheduled for ${timeForDay} in ${zone_name}.</p>
        <p>Reason for cancellation: ${reason}</p> 
        <p>Further details may appiear in your profile.</p>
...
module.exports = { ArcadeCloseArcade };
