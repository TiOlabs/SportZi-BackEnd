...
const authorizePlayer = require("../middlewares/authorizePlayer");
 ...
 router.get("/api/getcoachfeedbacks/:coachId", coachFeedbacksController.getCoachFeedbacks);
router.post("/api/addcoachfeedbacks/:coachId",authenticateToken,coachFeedbacksController.addCoachFeedbacks);
